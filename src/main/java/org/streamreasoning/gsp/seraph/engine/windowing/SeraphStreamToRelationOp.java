package org.streamreasoning.gsp.seraph.engine.windowing;
...
import org.streamreasoning.gsp.seraph.engine.TimeVaryingPGraph;
...
public class SeraphStreamToRelationOp<T1, T2> extends ObservableStreamToRelationOp<T1, T2> {
    ...
    @Override
    protected Content<T1, T2> setVisible(long t_e, Window w, Content<T1, T2> c) {
