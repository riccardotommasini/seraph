...
public class ContentPGraph implements Content<PGraph, PGraph> {
    ...
    public String toString() {
        PGraph pGraph = elements.get(0);
        String s1 = pGraph.toString();
        String s = "[" + elements.stream().map(e -> e.toString()).collect(Collectors.joining()) + "]";
        return s;
    }
...
//    }
    ...
    public List<PGraph> getElements() {
        return elements;
    }
